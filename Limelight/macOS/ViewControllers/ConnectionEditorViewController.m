...
- (void)loadView {
    ...
    NSTextField *currentLabel = [NSTextField labelWithString:@"This Connection"];
    ...
    self.addField.placeholderString = @"Add address (IP, domain or IPv6; port optional)";
...
- (void)updateSummaryLabels {
    ...
    self.autoLabel.stringValue = [NSString stringWithFormat:@"Automatic selection: %@", autoAddr];
}
...
- (void)handleDoubleClick:(id)sender {
    ...
    alert.informativeText = @"Changing the address will replace the current connection.";
